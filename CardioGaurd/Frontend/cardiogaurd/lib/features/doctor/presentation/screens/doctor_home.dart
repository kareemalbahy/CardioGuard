  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthCubit, AuthState>(
      builder: (context, authState) {
        ...
        final profilePic =
            user?.profileImageUrl ?? 'images/doctor_placeholder.png';
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              backgroundImage:
                                  CardioImageUtils.getImageProvider(
                                    request['patientProfileImageUrl']
                                            as String? ??
                            ...
                            Row(
                              children: [
                                IconButton(
                                  onPressed: () => context
                                      .read<DoctorPatientsCubit>()
                                      .rejectAssignment(request['id']),
                                  icon: const Icon(
                                    Icons.close,
                                    color: MyColors.alertRed,
                                    size: 20,
                                  ),
                                ),
                                IconButton(
